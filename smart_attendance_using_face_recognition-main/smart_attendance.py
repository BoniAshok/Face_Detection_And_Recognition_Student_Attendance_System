...
root.title('Smart Attendance System(author : Ashok)')
...
lbl=Label(root,text ="FACE DETECTION AND FACE RECOGNITION ATTENDANCE SYSTEM",fg ='red2' , font =("times new roman", 30),bg='light blue')
...
lbl2=Label(root,text ="Registration of Student",fg ='dark violet' , font =("times new roman", 30),bg='light blue')
...
def setTextInput2():
    ...
    def setTextInput3():
        ...
        if pass_word == "ashok123": # from here you can change your password
            conn = sqlite3.connect('attendance_database.db')
            curs = conn.cursor()
